                ...
                <x-dropdown align="right" width="48" contentClasses="py-1 bg-white text-slate-700">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button type="submit" class="block w-full px-4 py-2 text-start text-sm leading-5 text-slate-700 hover:text-slate-900 hover:bg-slate-50 focus:outline-none focus:bg-slate-50 transition duration-150 ease-in-out">
                                {{ __('Log Out') }}
                            </button>
                        </form>
                    </x-slot>
        ...
        <div class="pt-4 pb-1 border-t border-slate-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-slate-600 hover:text-teal-800 hover:bg-teal-50/50 hover:border-teal-200 focus:outline-none focus:text-teal-800 focus:bg-teal-50 focus:border-teal-200 transition duration-150 ease-in-out">
                        {{ __('Log Out') }}
                    </button>
                </form>
            </div>
